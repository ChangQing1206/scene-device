...
#define  PRODUCTID            "admin"                                    //产品ID   可以改成vistor
#define  PRODUCTID_LEN        strlen(PRODUCTID)                           //产品ID长度
//#define  DEVICEID             "702197187"                                 //设备ID 
#define  DEVICEID             "000000001"  
#define  DEVICEID_LEN        strlen(DEVICEID)                             //设备ID长度
#define  AUTHENTICATION      "BBb815416"                                      //鉴权信息  
#define  AUTHENTICATION_LEN    strlen(AUTHENTICATION)					  //鉴权信息长度


/**  mqtt客户端订阅的主题  */
// 向售票系统客户端订阅的获取clientId的主题发送游客的clientId
// #define  get_clientId 				"ticket/get_clientId"


#define  S_TOPIC_NAME         "i like mqtt"                               //需要订阅的主题  
#define  P_TOPIC_NAME         "i like mqtt" 
#define  Data_TOPIC_NAME      "$dp"
#define  Data_TOPIC_NAME1     "i like mqtt" 
