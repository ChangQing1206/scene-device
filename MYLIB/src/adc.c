...
/*配置采样通道端口 使能GPIO时钟	  设置ADC采样PA4端口信号*/
...
/*配置采样通道端口 使能GPIO时钟	  设置ADC采样PA6端口信号*/
...
//  DMA_Cmd(DMA1_Channel1, ENABLE);  //使能DMA通道
  ...
  ADC_RegularChannelConfig(ADC1, ADC_Channel_4, 1, ADC_SampleTime_55Cycles5); //通道1采样周期55.5个时钟周期
...
//  
//  /* Enable DMA channel2 */
//  DMA_Cmd(DMA1_Channel2, ENABLE);  //使能DMA通道
  ...
  /* ADC1 regular channel11 configuration */ 
  ADC_RegularChannelConfig(ADC2, ADC_Channel_6, 1, ADC_SampleTime_71Cycles5); //通道1采样周期55.5个时钟周期
